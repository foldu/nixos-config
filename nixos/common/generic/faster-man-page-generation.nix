# stolen from https://github.com/MidAutumnMoon/Nuran/blob/6a4708cb2c4b46c97fd1ee98fd8f2b77df13bfe6/nixos/documentation/default.nix
{
  pkgs,
  config,
  lib,
...
lib.mkIf (cfg.enable) {
  ...
  environment.extraSetup = # bash
    ''
      # Removes multilingual man pages
      find "$out/share/man" \
