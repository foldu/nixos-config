...
use ~/.config/nushell/kanagawa.nu
...
$env.config = {
    ...
    color_config: (kanagawa) # if you want a more interesting theme, you can replace the empty record with `$dark_theme`, `$light_theme` or another custom record
    use_grid_icons: true
